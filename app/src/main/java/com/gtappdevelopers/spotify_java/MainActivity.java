...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // on below line calling method to load our recycler views and search view.
        initializeAlbumsRV();
    ...
    private void initializeSearchView() {
        // on below line initializing our edit text for search views.
    ...
    // below method is use to open search tracks activity to search tracks.
    private void searchTracks(String searchQuery) {
        // on below line opening search activity to display search results in search activity.
    ...
    protected void onStart() {
        super.onStart();
        // on below line calling generate token method to generate token.
        generateToken();
    }

    private void generateToken() {
        // on below line creating a variable for url to generate access token
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    // on below line getting access token and saving it to shared prefrences.
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                // on below line passing headers. Make sure to add your authorization.
